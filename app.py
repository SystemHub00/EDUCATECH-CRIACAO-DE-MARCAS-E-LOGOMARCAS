    ...
    <style>
        ...
        * {
        ...
        .wizard-progress {
            ...
            box-shadow: 0 12px 30px rgba(14, 119, 82, 0.12);
        }
        ...
        .wizard-fill {
            height: 100%;
            width: 25%;
            background: linear-gradient(90deg, #0e7752 0%, #45b98a 100%);
            border-radius: 999px;
        ...
        .hero-card {
            padding: 32px;
            border-radius: 30px;
            background: linear-gradient(135deg, #fff 0%, #f5fcf8 58%, #def5ea 100%);
            border: 1px solid #c6e8d8;
            width: 100%;
            text-align: center;
        }
        ...
        .step-card {
            ...
            background: #fff;
            box-shadow: 0 8px 24px rgba(14, 119, 82, 0.08);
        }
        ...
        .timeline-card {
            padding: 14px 10px;
            background: linear-gradient(180deg, #0e7752 0%, #45b98a 100%);
            color: #fff;
        }
        ...
        .form-group select {
            ...
            -moz-appearance: none;
            background-image: url('data:image/svg+xml;utf8,<svg fill="%230e7752" height="20" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/></svg>');
        ...
        .form-group textarea:focus {
            border-color: var(--cor-principal);
            background: #fff;
            box-shadow: 0 0 0 4px rgba(14, 119, 82, 0.12);
        }

        .readonly-field {
            background: #eef9f4 !important;
            color: #2f6a55 !important;
            font-weight: 700;
        }
        ...
        .icon-button {
            ...
            background: var(--cor-principal);
            color: #fff;
            box-shadow: 0 8px 16px rgba(14, 119, 82, 0.22);
        }
        ...
        .submit-button {
            background: linear-gradient(90deg, #0e7752 0%, #45b98a 100%);
            color: #fff;
            box-shadow: 0 10px 24px rgba(14, 119, 82, 0.24);
        }
        ...
        .erro-campo {
            border-color: #0e7752 !important;
            box-shadow: 0 0 0 4px rgba(14, 119, 82, 0.12) !important;
        }
                        ...
                        <div class="hero-card">
                            ...
                            <p class="hero-subtitle">
                                Capacitação Profissional com Ênfase em Novas Tecnologias para Ingresso e Permanência no Mercado de Trabalho!<br>
                                    📍Local: Avenida João XXIII, 53, Rua 01, Quadra D, Casa 07 - Santa Cruz
                            </p>
                            <div class="hero-highlights">
                                ...
                                <div class="hero-highlight">
                                    ...
                                    ✅100% Gratuito<br>
                                    📃Com Certificação<br>
                                    👥Capacitação Profissional Completa<br>
                    ...
                    <div class="step-card">
                        ...
                        <div class="step-grid step-grid--stacked">
                            <div class="form-group">
                                ...
                                <input type="text" id="local" name="local" class="readonly-field" readonly value="{{ form_data.get('local', 'SANTA CRUZ') }}">
                            </div>

                            <div class="form-group">
                                <label for="opcao_id">Curso *</label>
                                <select id="opcao_id" name="opcao_id">
                                    <option value="" {% if not form_data.get('opcao_id') %}selected{% endif %}>Selecione um curso</option>
                                    {% for option in course_options %}
                                    <option value="{{ option.id }}" {% if form_data.get('opcao_id') == option.id %}selected{% endif %}>{{ option.curso }}</option>
                                    {% endfor %}
                                </select>
                            ...
                            <div class="form-group">
                                <label for="curso">Curso selecionado</label>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function validarPassoEscolher() {
                if (!courseOptionsById[String(optionInput.value)]) {
                    setError('opcao_id', 'Selecione um curso válido.');
                    optionInput.focus();
                    return false;
                }
                setError('opcao_id', '');
            ...
            ['nome', 'genero', 'whatsapp', 'cep', 'bairro', 'email', 'opcao_id', 'local', 'curso', 'turma', 'dias_aula', 'horario', 'data_inicio', 'encerramento', 'endereco_curso', 'como_conheceu'].forEach(function(fieldId) {
                const field = document.getElementById(fieldId);
                if (!field) {
                    return;
                }
...
<head>
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            background:
                radial-gradient(circle at top left, rgba(14, 119, 82, 0.15), transparent 32%),
                linear-gradient(140deg, #f5fcf8 0%, #fff 55%, #def5ea 100%);
            font-family: 'Wise', Arial, sans-serif;
        }

        .main-header {
            border-bottom: 4px solid #0e7752;
            background: rgba(255, 255, 255, 0.92);
        }
...
def validate_form_data(form_data):
    ...
    if not selected_option:
        errors["opcao_id"] = "Selecione um curso válido."
